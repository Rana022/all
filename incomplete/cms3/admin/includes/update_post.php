...
if (isset($_POST['update_post'])) {
   ...
   $query = "UPDATE `posts` SET `post_title` = '$post_title', `post_date` = '$post_date', `post_image` = '$post_image', `post_category` = '$post_category', `post_content` = '$post_content', `post_tags` = '$post_tags' WHERE `posts`.`post_id` = $up_id;";
