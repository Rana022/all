...
if (isset($_POST['create_post'])) {
   ...
   $query ="INSERT INTO `posts` (`post_id`, `post_title`, `post_date`, `post_category`, `post_image`, `post_content`, `post_tags`) VALUES (NULL, '$post_title', '$post_date', '$post_category', '$post_image', '$post_content', '$post_tags')";
